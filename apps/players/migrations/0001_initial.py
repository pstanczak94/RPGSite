    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='players.Player')),
                ('vip_player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vip_player', to='players.Player')),
            ],
            options={
                'verbose_name': 'vip list',
                'verbose_name_plural': 'vip lists',
        ...
        migrations.AlterUniqueTogether(
            name='playerviplist',
            unique_together=set([('player', 'vip_player')]),
        ),
        migrations.AlterUniqueTogether(
            name='playerstorage',
